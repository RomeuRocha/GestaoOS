...
import { Create, ReferenceInput, SelectInput, SimpleForm, TextInput, DateInput, NumberInput } from 'react-admin'
import Grid from '@mui/material/Grid2';
import Box from '@mui/material/Box';

const OrdemServicoCreate = props => {
            ...
            <SimpleForm>
                <Box sx={{ flexGrow: 1, width: '100%' }} >
                    <Grid container spacing={2}>
                        ...
                        <Grid size={{ xs: 3, md: 3, sm: 12 }}>
                            <SelectInput source="situacao" choices={[
...
export default OrdemServicoCreate
